...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/fcg-pengo: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/fcg-pengo ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/src/3DObject.o: src/3DObject.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/3DObject.o src/3DObject.cpp

${OBJECTDIR}/src/AngularMovement.o: src/AngularMovement.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/AngularMovement.o src/AngularMovement.cpp

${OBJECTDIR}/src/Block.o: src/Block.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Block.o src/Block.cpp

${OBJECTDIR}/src/Conception.o: src/Conception.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Conception.o src/Conception.cpp
...
${OBJECTDIR}/src/EnemyInteligence.o: src/EnemyInteligence.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/EnemyInteligence.o src/EnemyInteligence.cpp

${OBJECTDIR}/src/GameController.o: src/GameController.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/GameController.o src/GameController.cpp

${OBJECTDIR}/src/Item.o: src/Item.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Item.o src/Item.cpp

${OBJECTDIR}/src/LinearMovement.o: src/LinearMovement.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/LinearMovement.o src/LinearMovement.cpp

${OBJECTDIR}/src/Modelable.o: src/Modelable.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Modelable.o src/Modelable.cpp

${OBJECTDIR}/src/Movable.o: src/Movable.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Movable.o src/Movable.cpp

${OBJECTDIR}/src/Movement.o: src/Movement.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Movement.o src/Movement.cpp
...
${OBJECTDIR}/src/Observer.o: src/Observer.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Observer.o src/Observer.cpp

${OBJECTDIR}/src/Penguin.o: src/Penguin.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Penguin.o src/Penguin.cpp

${OBJECTDIR}/src/Scenario.o: src/Scenario.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Scenario.o src/Scenario.cpp
...
${OBJECTDIR}/src/bitmap.o: src/bitmap.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/bitmap.o src/bitmap.c

${OBJECTDIR}/src/glm.o: src/glm.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/glm.o src/glm.cpp

${OBJECTDIR}/src/glmimg.o: src/glmimg.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/glmimg.o src/glmimg.cpp
